...
// Ruta de los íconos en public/icons/
const icons = {
  HTML: "/icons/html.png",
  CSS: "/icons/css-3.png",
...
const skillsData = [
  {
    title: "Frontend",
    color: "text-sky-400",
    hoverColor: "hover:shadow-sky-400/20",
    items: [
  ...
  },
  {
    ...
    hoverColor: "hover:shadow-purple-400/20",
    items: [
...
const additionalSkills = [
  "Angular", "FastAPI", "Django", "Firebase", 
  "Supabase", "Jest", "Cypress", "Sass", "Material-UI"
];
...
const Skills = () => (
  <section id="skills" className="section-padding overflow-hidden">
    <div className="container overflow-hidden">
      ...
      </div> {/* <-- Este cierra el último grid de la segunda fila */}
